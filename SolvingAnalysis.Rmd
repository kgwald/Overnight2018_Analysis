...
kable(e_propsolv, digits = 2, align = 'c', caption = "Evening Solving Rates") %>%
...
kable(m_propsolv, digits = 2, align = 'c', caption = "Morning Solving Rates") %>%
  kable_styling("striped", full_width = FALSE, position = "left")
...
kable(m_propsolv_CU, digits = 2, align = 'c', caption = "Morning Solving Rates by Cueing") %>%
  kable_styling("striped", full_width = FALSE, position = "left")

#Overall cueing effect
cm <- colMeans(m_propsolv_CU[,2:4])

kable(cm, digits = 2, align = 'c', caption = "Overall Cueing Effect") %>%
  kable_styling("striped", full_width = FALSE, position = "left")
